...
export const getExtBlockFixed = createAsyncThunk(
    ...
    async () => {
        const res = await axios.get(`https://3.34.141.196:3000/ExtBlock/ExtBlockFixed`)
        return res.data
    }
)
...
export const getExtBlockCustom = createAsyncThunk(
    ...
    async () => {
        const res = await axios.get(`https://3.34.141.196:3000/ExtBlock/ExtBlockCustom`)
        return res.data
    }
)
...
export const putExtBlockFixedChk = createAsyncThunk(
    ...
    async (obj) => {
        const id = obj.id
        const res = await axios.put(`https://3.34.141.196:3000/ExtBlock/ExtBlockFixed/${id}`, obj)
        return obj;
    }
)
export const addExtBlockCustom = createAsyncThunk(
    ...
    async (extension) => {
        ...
        const res = await axios.post(`https://3.34.141.196:3000/ExtBlock/ExtBlockCustom/${newCustom}`);
        return extension;
    }
)
export const delExtBlockCustom = createAsyncThunk(
    ...
    async (id) => {
        console.log(id);
        const res = await axios.delete(`https://3.34.141.196:3000/ExtBlock/ExtBlockCustom/${id}`, id)
        return id;
    }
)
